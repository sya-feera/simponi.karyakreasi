...
export default function Dashboard() {
    const stats = [
        ...
        title: 'Total Santri',
        value: '5789',
        icon: <FaUserGraduate size={24} color="#6c5ce7" />,
        },
        {
        title: 'Total Mudaris',
        value: '1234',
        icon: <FaChalkboardTeacher size={24} color="#6c5ce7" />,
        },
        {
        title: 'Asrama',
        value: '9876',
        icon: <FaHome size={24} color="#6c5ce7" />,
        },
        {
        title: 'Kelas',
        value: '100',
        icon: <FaDoorOpen size={24} color="#6c5ce7" />,
        },
    ];

    const chartData = [
        { name: 'Santri', value: 5789 },
        { name: 'Mudaris', value: 1234 },
        { name: 'Asrama', value: 9876 },
        { name: 'Kelas', value: 100 },
    ];
