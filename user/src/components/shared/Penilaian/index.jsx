                    ...
                    <div className="mb-4 mt-4 mx-4">
                        <div className="d-flex align-items-center mb-4">
                            <div className="p-3 rounded me-3 text-white" style={{ backgroundColor: '#A8D5BA' }}>
                                <i className="bi bi-clipboard-data-fill fs-4" style={{ color: '#2d5a41' }}></i>
                            </div>
                            <div>
                                <h3 className="mb-1 text-dark fw-bold">Penilaian</h3>
                                <p className="text-muted mb-0">Lihat nilai mata pelajaran anda</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row mb-4 mx-2">
                                ...
                                <div className="card border-0 shadow-sm">
                                    <div className="card-body d-flex align-items-center">
                                        <div className="p-2 rounded text-white me-3" style={{ backgroundColor: '#A8D5BA' }}>
                                            <i className="bi bi-award fs-5" style={{ color: '#2d5a41' }}></i>
                                        </div>
                                        <div>
                                            <small className="text-muted fw-medium">Rata-rata Nilai</small>
                            ...
                            <div className="col-md-6 mb-3">
                                <div className="card border-0 shadow-sm">
                                    <div className="card-body d-flex align-items-center">
                                        <div className="p-2 rounded text-white me-3" style={{ backgroundColor: '#A8D5BA' }}>
                                            <i className="bi bi-book fs-5" style={{ color: '#2d5a41' }}></i>
                                        </div>
                                        <div>
                        ...
                        <div className="card border-0 shadow-sm mb-5 mx-4">
                            <div className="card-header bg-white d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <small className="text-muted">Nama Santri: <span className="fw-medium">{santriName}</span></small>
                                </div>
                                <div className="text-end">
                                    <small className="text-muted">Rata-rata:</small>
                                    <h6 className="mb-0 fw-bold" style={{ color: '#2d5a41' }}>{calculateAverage()}</h6>
                                </div>
                            </div>
                    ...
                    {!showGrades && (
                        <div className="card border-0 shadow-sm mb-5 mx-4">
                            <div className="card-body text-center py-5">
                                <div className="mb-4">
                                    <i className="bi bi-clipboard-data display-1" style={{ color: '#A8D5BA' }}></i>
                                </div>
                                <h4 className="fw-bold mb-3" style={{ color: '#2d5a41' }}>Selamat Datang, {santriName}!</h4>
                                <p className="text-muted mb-4">
                                    Klik tombol "Tampilkan Nilai saya" untuk melihat hasil penilaian mata pelajaran Anda.
                                </p>
                                <div className="row justify-content-center">
                                    <div className="col-md-8">
                                        <div className="alert alert-info border-0" style={{ backgroundColor: '#E8F5E8', color: '#2d5a41' }}>
                                            <i className="bi bi-info-circle me-2"></i>
                                            <strong>Info:</strong> Nilai akan ditampilkan dalam bentuk tabel dengan detail status dan progress untuk setiap mata pelajaran.
                                        </div>
                                    </div>
                                </div>
                            </div>
